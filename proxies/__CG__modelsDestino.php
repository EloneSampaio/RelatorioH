 ...
 */
class Destino extends \models\Destino implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'models\\Destino' . "\0" . 'id', '' . "\0" . 'models\\Destino' . "\0" . 'cor', '' . "\0" . 'models\\Destino' . "\0" . 'tipo', '' . "\0" . 'models\\Destino' . "\0" . 'descricao', '' . "\0" . 'models\\Destino' . "\0" . 'equipamentosPorta', '' . "\0" . 'models\\Destino' . "\0" . 'patchpanelPorta', '' . "\0" . 'models\\Destino' . "\0" . 'codigo', '' . "\0" . 'models\\Destino' . "\0" . 'equipamentos', '' . "\0" . 'models\\Destino' . "\0" . 'patchpanel', '' . "\0" . 'models\\Destino' . "\0" . 'usuarios', '' . "\0" . 'models\\Destino' . "\0" . 'cabos');
        }
    ...
    public function Insert($objecto, $equipamento, $patchpanel, $cabo)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'Insert', array($objecto, $equipamento, $patchpanel, $cabo));

        return parent::Insert($objecto, $equipamento, $patchpanel, $cabo);
    }
    ...
    public function listagem($id)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'listagem', array($id));

        return parent::listagem($id);
    }
