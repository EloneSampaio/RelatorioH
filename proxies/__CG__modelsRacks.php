 ...
 */
class Racks extends \models\Racks implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'models\\Racks' . "\0" . 'id', '' . "\0" . 'models\\Racks' . "\0" . 'nome', '' . "\0" . 'models\\Racks' . "\0" . 'descricao', '' . "\0" . 'models\\Racks' . "\0" . 'usuarios');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Racks $proxy) {
