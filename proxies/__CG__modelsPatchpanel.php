 ...
 */
class Patchpanel extends \models\Patchpanel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'models\\Patchpanel' . "\0" . 'id', '' . "\0" . 'models\\Patchpanel' . "\0" . 'descricao', '' . "\0" . 'models\\Patchpanel' . "\0" . 'tipo', '' . "\0" . 'models\\Patchpanel' . "\0" . 'racks', '' . "\0" . 'models\\Patchpanel' . "\0" . 'usuarios');
        }
     ...
     * {@inheritDoc}
     */
    public function getNomeInter()
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomeInter', array());

        return parent::getNomeInter();
    }

    /**
     * {@inheritDoc}
     */
    public function setNomeInter($nomeInter)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomeInter', array($nomeInter));

        return parent::setNomeInter($nomeInter);
    }
