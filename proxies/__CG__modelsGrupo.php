 ...
 */
class Grupo extends \models\Grupo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'models\\Grupo' . "\0" . 'id', '' . "\0" . 'models\\Grupo' . "\0" . 'nome', '' . "\0" . 'models\\Grupo' . "\0" . 'nivel', '' . "\0" . 'models\\Grupo' . "\0" . 'descricao');
        }
